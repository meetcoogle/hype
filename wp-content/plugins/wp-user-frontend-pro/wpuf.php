...
class WP_User_Frontend {
    ...
    function license_expired() {
        ...
        echo '<p>Your <strong>WP User Frontend Pro Pro</strong> License has been expired and you are now <strong>downgraded</strong> to free version. Please <a href="https://wedevs.com/account/" target="_blank">renew your license</a>.</p>';
        echo '</div>';
    }
}
