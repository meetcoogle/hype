		...
		<div class="rel_pos">
			...
			<div class="container">
				...
				?>
					...
					{
						$logoutID = '<li id="menu-item-99999" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-99999"><a href="' . wp_logout_url( $redirect ) . '" title="' .  __( 'Logout' ) .'">' . __( 'Logout' ) . '</a></li>';
					}else{
						$logoutID = '<li id="menu-item-99999" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-99999"><a href="' . wp_login_url($redirect) . '" title="' .  __( 'Login' ) .'">' . __( 'Login' ) . '</a></li>';
