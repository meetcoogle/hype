<?php 
/* 
Template Name: Home SignUP Page
*/ 
get_header(); 
?>
	<style type="text/css">
...
.mu_register input[type="text"], input[type="password"], input[type="email"], input[type="tel"], textarea, select {
...
<?php	// User name
	...
	echo '<input name="user_name" type="text" id="user_name" value="'. esc_attr( $user_name ) .'" autocapitalize="none" autocorrect="off" maxlength="60" />';
...
if ( $active_signup == 'none' ) {
	...
	$login_url = wp_login_url( network_site_url( '' ) );
