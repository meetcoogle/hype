...
$custom_settings = array(
  ...
  'settings'        => array(
	...
	array(
	  'label'       => 'Upload Logo - W=P=L=O=C=K=E=R=.=C=O=M',
	  'id'          => 'logo_upload',
	  'type'        => 'upload',
	...
	array(
		...
		'std'         => '<a href="http://themeforest.net/item/fortuna-responsive-multipurpose-wordpress-theme/12496833?ref=blueowlcreative" target="_blank">Fortuna Theme</a> &copy; 2015 &nbsp; | &nbsp; <a href="http://themeforest.net/user/blueowlcreative/portfolio?ref=blueowlcreative" target="_blank">BlueOwlCreative</a>',
		'section'     => 'footer'
	),
